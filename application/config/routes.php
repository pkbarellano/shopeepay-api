...
$route['v1/sandbox/transaction/check']['POST'] = 'api/sandbox/V1/TransactionCheck_controller/create';
...
$route['v1/transaction/check']['POST'] = 'api/production/V1/TransactionCheck_controller/create';
